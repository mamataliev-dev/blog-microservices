...
from grpc_api.messages import user_pb2 as user__pb2
...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetCollectionUsers = channel.unary_unary(
            '/user.UserService/GetCollectionUsers',
            request_serializer=user__pb2.GetCollectionUsersRequest.SerializeToString,
            response_deserializer=user__pb2.GetCollectionUsersResponse.FromString,
            _registered_method=True)
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'GetCollectionUsers': grpc.unary_unary_rpc_method_handler(
            servicer.GetCollectionUsers,
            request_deserializer=user__pb2.GetCollectionUsersRequest.FromString,
            response_serializer=user__pb2.GetCollectionUsersResponse.SerializeToString,
        ),
...
class UserService(object):
    ...
    @staticmethod
    def GetCollectionUsers(request,
                           target,
                           options=(),
                           channel_credentials=None,
                           call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/user.UserService/GetCollectionUsers',
            user__pb2.GetCollectionUsersRequest.SerializeToString,
            user__pb2.GetCollectionUsersResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
